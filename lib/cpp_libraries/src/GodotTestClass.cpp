...
/** GDNative Initialize **/
extern "C" void GDN_EXPORT GodotGdnativeInit(godot_gdnative_init_options * options)
{
	godot::Godot::gdnative_init(options);
}

/** GDNative Terminate **/
extern "C" void GDN_EXPORT GodotGdnativeTerminate(godot_gdnative_terminate_options * options)
{
	godot::Godot::gdnative_terminate(options);
}

/** NativeScript Initialize **/
extern "C" void GDN_EXPORT GodotNativescriptInit(void * handle)
{
